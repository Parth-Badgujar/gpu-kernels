...
uint32_t make_idesc_mxf4nvf4(
    uint32_t MMA_M, uint32_t MMA_N,
    uint32_t transpose_a = 0,
    uint32_t transpose_b = 0,
    uint32_t sfa_data_id = 0,
...
__device__ __forceinline__
void tcgen_commit_arrive_one(uint32_t mbar) {
