...
void mbarrier_wait(uint32_t mbar_addr, uint32_t phase) {
...
__device__ __forceinline__
void mbarrier_arrive_expect_tx(uint32_t mbar_ptr, uint32_t tx_bytes) {
    asm volatile(
...
__device__ __forceinline__
void mbarrier_arrive_expect_tx_cluster(uint32_t mbar_ptr, uint32_t tx_bytes) {
...
__device__ __forceinline__
void mbarrier_expect_tx(uint32_t mbar_ptr, uint32_t tx_bytes) {
    asm volatile(
...
__device__ __forceinline__
void mbarrier_expect_tx_cluster(uint32_t mbar_ptr, uint32_t tx_bytes) {
    asm volatile(
...
__device__ __forceinline__
void mbarrier_init(uint32_t mbar_ptr, uint32_t thread_count = 1) {
...
__device__ __forceinline__
void mbarrier_arrive(uint32_t mbar_ptr) {
    asm volatile(
...
__device__ __forceinline__
void mbarrier_arrive_count(uint32_t mbar_ptr, uint32_t count) {
    asm volatile(
...
__device__ __forceinline__
void mbarrier_arrive_cluster(uint32_t mbar_ptr) {
    asm volatile(
...
__device__ __forceinline__
void cp_async_mbarrier_arrive(uint32_t mbar_ptr) {
    asm volatile(
...
__device__ __forceinline__
void cp_async_mbarrier_arrive_noinc(uint32_t mbar_ptr) {
    asm volatile(
...
__device__ __forceinline__
uint32_t mbarrier_get_pending_tx_count(uint64_t state) {
    uint32_t count;
...
__device__ __forceinline__
bool mbarrier_test_wait(uint32_t mbar_ptr, uint32_t phase) {
    uint32_t is_ready = 0;
    asm volatile("{\n\t"
                 ".reg .pred p;\n\t"
...
__device__ __forceinline__
uint64_t mbarrier_arrive_state(uint32_t mbar_ptr){
    uint64_t state;
