...
void tcgen_cp_32x128_warpx4(uint32_t taddr, uint64_t sdesc) {
    asm volatile(
...
__device__ __forceinline__
void tcgen_cp_128x128(uint32_t taddr, uint64_t sdesc) {
...
__device__ __forceinline__
void tcgen_cp_128x256(uint32_t taddr, uint64_t sdesc) {
...
__device__ __forceinline__
void tcgen_ld_32x32_x128(float tmp[], uint32_t addr) {
    asm volatile(
...
__device__ __forceinline__
void tcgen_ld_32x32_x8(float tmp[], uint32_t addr) {
...
__device__ __forceinline__
void tcgen_ld_wait_sync() {
    asm volatile("tcgen05.wait::ld.sync.aligned;");
}

__device__ __forceinline__
void tcgen_alloc(uint32_t *tmem_addr_ptr, uint32_t ncols) {
...
__device__ __forceinline__
void tcgen_delloc(uint32_t taddr, uint32_t ncols) {
